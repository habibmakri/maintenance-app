                    ...
                    .then(data => {
                        ...
                        chart.setOption({
                            title: {
                                ...
                                text: `${piece} Du ${monthInput.options[monthInput.selectedIndex].text} ${year} - Valeur moyenne ${parseFloat(meanValue).toFixed(2)}`,
                                left: 'center',
                            },
                            tooltip: {
                                trigger: 'axis',
                                ...
                                formatter: function(params) {
                                    ...
                                    return `${params[0].axisValue} : <strong>${parseFloat(params[0].data.value).toFixed(2)}</strong>`;
                                }
                            },
                            xAxis: {
                                type: 'category',
