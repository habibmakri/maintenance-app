...
@section('content')
    ...
    <div class="tab-content pt-2" id="borderedTabContent" style = "font-family: 'Tajwal';">
        ...
        <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab" dir="rtl">
            ...
            <div style="border-bottom: solid;border-block-width: 2px;padding-bottom: 10px;" dir="rtl">
                <h5 class="mt-5" style = "font-family: 'Tajwal';font-weight: bold">إختر السنة لإستخراج الحوادث  المصرح بها عند CAAT والتي لم تعوض بعد:</h5>
                <form class="row g-3" action="{{ route('app.judiciaire.accident_nonpaye') }}" method="post" >
                    @csrf
                    <div class="col-md-10">
                        <div class="form-floating">
                            <select class="form-select" required name="year" id="year"
            ...
            <div style="border-bottom: solid;border-block-width: 2px;padding-bottom: 10px;" dir="rtl">
                <h5 class="mt-5" style = "font-family: 'Tajwal';font-weight: bold">إختر السنة لإستخراج السائقين الذين لم يرتكبو حوادث :</h5>
                <form class="row g-3" action="{{ route('app.judiciaire.chauffeur_pasaccident') }}" method="post" >
                    @csrf
                    <div class="col-md-10">
                        <div class="form-floating">
                            <select class="form-select" required name="year" id="year"
