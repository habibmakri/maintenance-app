@extends('base')
@section('title', 'Listes des taxis')
@section('content')

    <div class="pagetitle">
        <h1>Listes des Taxis</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('app.main') }}">App</a></li>
                <li class="breadcrumb-item">Formaion</li>
                <li class="breadcrumb-item active">Listes des Taxis</li>
            </ol>
        </nav>
        <div class="text-end">
            @if ($allConfirmed)
                <a href="{{ route('app.formation.create_list') }}" class="btn btn-primary">
                    Nouvelle Liste
                </a>
            @else
