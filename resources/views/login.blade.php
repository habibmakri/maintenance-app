                ...
                <div class="card-body">
                  <div class="d-flex justify-content-center py-4">
                    <span  class="logo d-flex align-items-center w-auto">
                      ...
                      <span class="d-none d-lg-block" style="font-family: 'Tajwal', sans-serif;text-align: end;cursor:default;">المؤسسة العمومية للنقل الحضري<br> والشبه الحضري سيدي بلعباس</span>
                    </span>

                  </div>
                  <div class="d-flex justify-content-center py-4">
                    <span  class="logo d-flex align-items-center w-auto">
                      <span class="d-none d-lg-block" style="font-family: 'Scheherazad', sans-serif;text-align: end;cursor:default; font-size:32px;">مؤسسة تتجدد مؤسسة تتطور ولا تتبدد</span>
                    </span>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" class="form-control" required name="email" id="email" @if($user->email!="") value="{{ old('email', $user->email)}}" @endif>
